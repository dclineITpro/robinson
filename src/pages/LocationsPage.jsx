                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-robinson-gray-light text-sm">{location.sqft} sq. ft.</div>
                    </div>
                    <ChevronRight className={`w-5 h-5 transition-colors ${
                      selectedLocation === location.id ? 'text-safety-orange' : 'text-robinson-gray-light'
                    }`} />
                  </div>
                </motion.button>
              ))}
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="relative">
                  ...
                  <div className="mt-6 flex gap-4">
                    ...
                    <Link
                      to="/careers"
                      className="px-6 py-3 border-2 border-white/30 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-300 flex items-center gap-2"
                    >
