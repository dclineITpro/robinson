...
const WhyRobinsonPage = () => {
  ...
  const locations = [
    ...
    { name: 'De Pere Facility 2 (DP2)', type: 'Manufacturing', sqft: '180,000', address: '2107 American Blvd' },
    { name: 'De Pere Facility 3 (DP3)', type: 'Manufacturing', sqft: '240,000', address: '2121 American Blvd' },
